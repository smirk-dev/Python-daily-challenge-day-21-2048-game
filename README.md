...
A modern and interactive version of the **2048 game** built using **Python** and **Pygame**. This game follows the classic tile-merging mechanics but with an improved UI/UX, smoother animations, and a dynamic menu system.

## 🎮 Features

- **Smooth tile movement & merging**
- **High score tracking** (stores best scores and moves)
- **Modern UI design** with improved tile aesthetics
- **Interactive menu** (Start, View High Scores, Quit)
- **Win & Game Over Screens** with restart options
- **Fully functional event handling** for keyboard inputs

## 🖥️ How to Play

1. Start the game and select "New Game" from the menu.
2. Use **arrow keys** to slide the tiles:
   - ⬆️ Up  
   - ⬇️ Down  
   - ⬅️ Left  
   - ➡️ Right  
3. Merge tiles of the same number to **double their value**.
4. **Reach 2048** to win! 🎉
